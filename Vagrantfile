# CONFIG
settingsMachineName = "UBG development machine"
settingsMachineRam = "1024"

settingsProxyEnabled = false;
settingsProxyHttp     = "http://192.168.93.30:81/"
settingsProxyHttps    = "http://192.168.93.30:81/"
settingsProxyNoProxy = "localhost,127.0.0.1"

settingsPortForwardHostHttp = 8931
...
Vagrant.configure(2) do |config|
  ...
  config.vm.network "forwarded_port", guest: 80, host: settingsPortForwardHostHttp
